...
`define DRIVE_OFFSET                      4
`define DRIVE_NUM_BANK                    2
`define DRIVE_NUM_QUBIT_PER_BANK          16
`define DRIVE_QUBIT_ADDR_WIDTH_PER_BANK   4
`define DRIVE_IQ_OUT_WIDTH                (13-`DRIVE_OFFSET)   // Usually IQ_OUT_WIDTH == IQ_CALI_WIDTH
...
`define DRIVE_NCO_N                       (26-`DRIVE_OFFSET)
...
// enve_memory
`define DRIVE_AMP_WIDTH                   (`DRIVE_IQ_OUT_WIDTH-1)
...
`define DRIVE_CALI_MEMORY_NUM_ENTRY       (`DRIVE_NUM_QUBIT_PER_BANK*6)
`define DRIVE_CALI_MEMORY_ADDR_WIDTH      (`DRIVE_QUBIT_ADDR_WIDTH_PER_BANK+`DRIVE_INST_TABLE_ADDR_WIDTH)
