...
set TOP_MODULE drive_circuit_mask_decoder
...
set mw_reference_library "/work/cryoCPU_RISCV/milky-45nm-4k"
set mw_design_library "/work/cryoCPU_RISCV/mw_design_lib_4k"
...
redirect ${REPORT_DIR}/critical_path_4k           {report_timing}
redirect ${REPORT_DIR}/power_4k                   {report_power -hierarchy -levels 4}
